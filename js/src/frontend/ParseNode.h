 ...
 *                          pn_kid2: null or CatchList list
 *                          pn_kid3: null or finally block
 * CatchList list       pn_head: list of PNK_LEXICALSCOPE nodes, one per
 *                                   catch-block, each with pn_expr pointing
 *                                   to a PNK_CATCH node
 * Catch    ternary     pn_kid1: PNK_NAME, PNK_ARRAY, or PNK_OBJECT catch var node
